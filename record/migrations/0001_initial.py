# Generated by Django 5.1.4 on 2025-04-27 12:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owed_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owed_balances', to=settings.AUTH_USER_MODEL)),
                ('owed_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owing_balances', to=settings.AUTH_USER_MODEL)),
            ],
            options={
